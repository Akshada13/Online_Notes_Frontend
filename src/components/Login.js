...
export default function Login() {
    ...
    function scheduleAlert(timer) {
     ...
     function submithandler(e) {
        e.preventDefault()
        axios.post('https://online-notes13.herokuapp.com/api/user/Userlogin', { email, password }).then((data)=>{
    ...
    return (
        <div className='my-2 mx-auto d-flex flex-column justify-content-evenly p-3' style={{ boxShadow: "0px 0px 10px rgb(0 0 0 / 14%)", width: "40%", backgroundColor: "pink" }}>
